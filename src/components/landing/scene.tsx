...
export function PhoneScene({ progress, position, guidance, sampleTime, enabled, onUnavailable }: { progress: RefObject<number>; position: number; guidance?: string; sampleTime?: number; enabled: boolean; onUnavailable: () => void }) {
