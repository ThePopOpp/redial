...
export default defineConfig({
  ...
  webServer:[
    ...
    {command:'npm run start -- --port 3212',url:'http://127.0.0.1:3212/api/health/live',reuseExistingServer:false,env:{REDIAL_DEPLOYMENT:'local',REDIAL_SITE_URL:'http://127.0.0.1:3212',SUPABASE_URL:'http://127.0.0.1:3213',SUPABASE_PUBLISHABLE_KEY:'sb_publishable_test_not_a_real_project',NEXT_TELEMETRY_DISABLED:'1'}},
  ],
});
