...
- No live charges, real test dialing, forwarding changes, campaigns, number provisioning/port/release or production deployment without specific authorization. Current scope is local development only.
